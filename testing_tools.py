...
def completed_shift():
    ...
    # extra stop 1
    extra_stop_1 = objects.Extra_Stop(shift, id=0)
    ...
    # extra stop 2
    extra_stop_3 = objects.Extra_Stop(shift, id=2)
    extra_stop_3.start_time =\
        To_Datetime('2020-08-25 13:17:38.100').from_datetime()
    extra_stop_3.location = 'walmart'
    extra_stop_3.reason = 'get batteries'
    extra_stop_3.distance = 4.1

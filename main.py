...
def startMenu():
    while True:
        if os.path.exists(os.path.join("shift", "shiftStartTime.txt")) == False:
        ...
        elif os.path.exists(os.path.join("shift", "shiftEndTime.txt")) == True:
        ...
        elif os.path.exists(os.path.join("shift", "shiftStartTime.txt")) == True and os.path.exists(os.path.join("shift", "splitStartTime.txt")) == False or os.path.exists(os.path.join("shift", "splitEndTime.txt")) == True:
            shiftMenu()
            print('\nwhat would you like to do?\n1 to continue shift | 0 for settings')
            try:
                userInput = int(input())
        ...
        elif os.path.exists(os.path.join("shift", "shiftStartTime.txt")) == True and os.path.exists(os.path.join("shift", "splitStartTime.txt")) == True:
...
def shiftMenu():
    while True:
        ...
        try:
            ...
            if userInput == 1:
                delivery.delivery()
                shutil.move(os.path.join("delivery"), os.path.join("shift", "delivery" + utilFunc.deliveryNumb('number')))
